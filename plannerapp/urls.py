...
urlpatterns = [
    ...
    path('edit_plan/<int:workout_plan_id>', views.EditPlan.as_view(), name='edit_plan'),
    path('delete_plan/<int:workout_plan_id>', views.DeletePlan.as_view(), name='delete_plan'),
]